export default function WhatYouGet() {
  const items = [
    ...
    },
    {
      ...
      body: "A durable, weather-resistant QR plaque that links directly to your Afterword page. Attach it to a headstone, memorial stone, urn, bench, or any surface you choose. Especially meaningful for families who chose cremation.",
    },
    {

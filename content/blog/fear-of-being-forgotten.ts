...
const post: BlogPost = {
  slug: "fear-of-being-forgotten",
  title: "The Fear of Being Forgotten Isn't Vanity, It's a Human Need to Be Understood",
  date: "2026-04-17",
  excerpt:
    "We've been taught to treat the desire to be remembered as a form of vanity. But the fear of being forgotten isn't about self-importance. It's about the fear of being misunderstood, or worse, flattened into a handful of facts that don't capture who you actually were.",
  content: `There's a moment that happens in almost every family, usually years after someone has died. You're sitting around a table, and someone says, "Wait, why did Grandpa leave medicine to become a carpenter?" or "What was Mom like before she had kids?" And the room goes quiet because no one actually knows. The story died with them.
